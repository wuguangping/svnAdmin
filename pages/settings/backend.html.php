...
$(document).ready(function(){
  ...
  $('#SVNServeFileTest').click(function(){
    testSettings("SVNServeFile", {SVNServeFile: $("#SVNServeFile").val()}, "#SVNServeFileTestResult");
  });
  ...
  $('#SvnServeExecutableTest').click(function(){
    testSettings("SvnServeExecutable", {SvnServeExecutable: $("#SvnServeExecutable").val()}, "#SvnServeExecutableTestResult");
  });

  $('#SvnServeExecutableRestart').click(function(){
    testSettings("SvnServeExecutableRestart", {SvnServeExecutable: $("#SvnServeExecutable").val()}, "#SvnServeExecutableRestartResult");
  });
...
<table class="datatable settings" id="tbl_subversion">
  ...
  <tr>
      <td><?php Translate("Subversion server config file (SVNServeFile)"); ?><br><small><b><?php Translate("Example"); ?>:</b> <?php PrintStringValue("SVNServeFileEx"); ?></small></td>
      <td>
          <input type="text" name="SVNServeFile" id="SVNServeFile" value="<?php PrintStringValue("SVNServeFile"); ?>">
          <input type="button" id="SVNServeFileTest" value="<?php Translate("Test"); ?>">
          <span id="SVNServeFileTestResult" style="display:none;"></span>
      </td>
  </tr>
    <tr>
    ...
    <tr>
      <td><?php Translate("Subversion server executable"); ?><br><small><b><?php Translate("Example"); ?>:</b> <?php PrintStringValue("SvnServeExecutableEx"); ?></small></td>
      <td>
        <input type="text" name="SvnServeExecutable" id="SvnServeExecutable" value="<?php PrintStringValue("SvnServeExecutable"); ?>">
        <input type="button" id="SvnServeExecutableTest" value="<?php Translate("Test"); ?>">
          <span id="SvnServeExecutableTestResult" style="display:none;"></span>
        <input type="button" id="SvnServeExecutableRestart" value="<?php Translate("Restart"); ?>">
        <span id="SvnServeExecutableRestartResult" style="display:none;"></span>
      </td>
    </tr>
  </tbody>
</table>
